...
const searchData: AppBarSearchType[] = [
  ...
  {
    id: 3,
    url: '/apps/employee/employee-designation/',
  ...
  {
    id: 4,
    url: '/apps/employee/employee-group/',
  ...
  {
    id: 5,
    url: '/apps/employee/employee-details/',
  ...
  {
    id: 8,
    url: '/customer/customer-contact-person/',
    icon: 'fluent-mdl2:contact-card',
    title: 'Customer Contact Person',
    category: 'Customer'
  },
  {
    id: 9,
    url: '/pricing/additional-charges/',
  ...
  {
    id: 10,
    url: '/pricing/pricing-categories/',
