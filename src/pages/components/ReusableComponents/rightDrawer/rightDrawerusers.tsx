...
const RightDrawerUsers: React.FC<DrawerComponentProps> = ({ anchor, onOpen, buttonLabel, children, width, textBoolean,closeCommand, updateParent }) => {
