...
import VehicleForm from './parentform'

const ParentTypeHeader = (props: any) => {
  // ** Props
  const { applyFilters, editId, resetFilters, fetchData, isWrite } = props
        ...
        >
          ...
          <Grid sx={{ display: 'flex', alignItems: 'center' }}>
            <DrawerComponent width='530px' anchor='right' onOpen={handleOpenDrawer} buttonLabel='Add New'>
              <VehicleForm fetchData={fetchData} editStatus resetEditid={resetEditid} editId={editId} />
            </DrawerComponent>
          </Grid>
        </Box>
      </Box>
