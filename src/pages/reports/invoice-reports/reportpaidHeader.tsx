...
const InvlicePaidReportHeader = (props: TableHeaderProps) => {
  const { setcustomer, showMessage, setShowMessage, companyName, setPickupDate } = props
...
export default InvlicePaidReportHeader
