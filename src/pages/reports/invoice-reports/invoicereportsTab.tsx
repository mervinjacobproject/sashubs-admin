...
import InvoiceDraftReports from './invoiceDraftreport'
import InvoiceNotPaidReport from './invoiceNotpaidreport'
import InvoicePaidReport from './invoicePaidreport'
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
       ...
       {[<InvoiceDraftReports key="draft"/>, <InvoiceNotPaidReport  key="notpaid" />, <InvoicePaidReport key="paid"/>].map((Component, index) => (
