...
import InvoiceAdditionalTableHeader from './invoiceAdditionalTableHeader'
  ...
  return (
    ...
    <DatePickerWrapper>
      <Grid container spacing={6}>
        ...
        <Grid item xs={12}>
          <Card>
            <InvoiceAdditionalTableHeader value={value} selectedRows={selectedRows} handleFilter={handleFilter} />
            <DataGrid
              autoHeight
              pagination
              rowHeight={62}
...
export default InvoiceAdditionalTable