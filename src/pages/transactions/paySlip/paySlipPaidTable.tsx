...
import PaidStatusDropdown from './paidStatusDropDown'
import PaySlipPaidHeader from 'src/pages/apps/invoice/list/payslipPaidHeader'
import AppSink from 'src/commonExports/AppSink'
import CustomTextField from 'src/@core/components/mui/text-field'
import jsPDF from 'jspdf'
import 'jspdf-autotable'
import PrintUrl from 'src/commonExports/printUrl'
import PaySlipPaidStatusDropdown from './payslippaidDraft'

const PaySlipPaidTable = ({handledraft,handlePaid,handleNotPaid}:any) => {
  ...
  const defaultColumns: GridColDef[] = [
...

    {
      ...
      renderCell: ({ row }: any) => (
        <>
          {row.Draft === 1 ? (
            <PaySlipPaidStatusDropdown handledraft={handledraft}
            handleNotPaid={handleNotPaid}
  ...
  return (
    <>
      <DatePickerWrapper>
        <Card>
          <PaySlipPaidHeader stateValue={stateValue} setAllDate={setAllDate} setAllEmpName={setAllEmpName} />
          <DataGrid
            autoHeight
            pagination
            rowHeight={62}
...
export default PaySlipPaidTable
