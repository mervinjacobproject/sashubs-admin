...
const PaySlipPaidStatusDropdown: React.FC<ActionsDropdownProps> = ({ rowId, fetchData, handlePaid,handleNotPaid,handledraft, defaultVal }) => {
...
export default PaySlipPaidStatusDropdown
