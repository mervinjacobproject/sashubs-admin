...
const NotPaidDraftDropdown: React.FC<ActionsDropdownProps> = ({ handledraft,handleNotPaid,handlePaid, rowId, fetchData, defaultVal }) => {
...
export default NotPaidDraftDropdown
