...
import DropDownInvoice from './dropDownInvoice'
...
const JobInvoiceTable = ({handlePaid,handleNotPaid,handledraft}:any) => {
  ...
  const selectRow = (selectedID: any) => {
    return Invoicelist.find((i: any) => i.ID === selectedID)
  }
...
<strong>PAYMENT ADVICE </strong><br>
  ...
  const defaultColumns: GridColDef[] = [
    ...
    },
    {
      ...
      field: 'Status',
      headerName: 'Status',
      renderCell: ({ row }) => <DropDownInvoice  handledraft={handledraft} handleNotPaid={handleNotPaid} handlePaid={handlePaid}  fetchData={fetchData} value={row.Status} rowId={row.ID} />
    },
    {
      field: 'Draft',
      ...
      renderCell: ({ row }: any) => (
        <>
          {row.Draft === false ? (
            <InvoiceDropDown fetchData={fetchData}  handledraft={handledraft} handleNotPaid={handleNotPaid} handlePaid={handlePaid}  value={row.Draft} rowId={row.ID} />
          ) : (
            <Button
              sx={{
