...
const NotPaidInvoiceStatusDropdown: React.FC<ActionsDropdownProps> = ({ rowId, value, fetchData, handlePaid, handleNotPaid, handledraft }: ActionsDropdownProps) => {
...
export default NotPaidInvoiceStatusDropdown;
