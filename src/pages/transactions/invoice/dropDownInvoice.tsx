...
const DropDownInvoice: React.FC<ActionsDropdownProps> = ({ rowId, value, fetchData,handlePaid,handleNotPaid,handledraft }: ActionsDropdownProps) => {
...
export default DropDownInvoice;
