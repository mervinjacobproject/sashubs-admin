...
import CategoryForm from 'src/pages/product/category/Categoryform'
        ...
        >
          ...
          <Grid sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              ...
              <CategoryForm onClose={handleModalClose} onFetchData={onFetchData} customergroupname={customergroupname} />
            </CustomModal>
          </Grid>
        </Box>
      </Box>
            ...
            >
              ...
              <Box sx={{ display: 'flex', alignItems: 'end', marginLeft: '20px', marginTop: '20px' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      <Button
                        onClick={() => applyFilters(activeStatus, categoryName)}
                        variant='contained'
                      >
