...
const DeletedCustomerGroupHeader = ({ bulkDelete, selectedRows, handleRestore }: any) => {
      ...
      >
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: "space-between", width: "100%", }}>
          <Grid sx={{ display: 'flex', gap: "15px" }}>
            <Button onClick={() => setModalOpenRestore(true)} disabled={selectedRows.length < 1}
              variant="contained"
              sx={{
            ...
            >
              <p style={{
                color:
                  getColor(), fontSize: '14px'
              }}>Are you sure you want to Restore?</p>
              <div
              ...
              >
                <Button
                  ...
                  onClick={() => { setModalOpenRestore(false) }}
                >
                  No
                </Button>
                <Button
...
export default DeletedCustomerGroupHeader
