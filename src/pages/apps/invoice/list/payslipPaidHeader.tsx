...
import { Box, Grid, Button, IconButton, Tooltip, Autocomplete } from '@mui/material'
...
const PaySlipPaidHeader: React.FC<TableHeaderProps> = ({
  stateValue,
  setAllDate,
  setAllEmpName,
}) => {
...
export default PaySlipPaidHeader
