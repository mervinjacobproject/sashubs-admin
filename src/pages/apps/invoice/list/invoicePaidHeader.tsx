...
const InvlicePaidHeader = (props: TableHeaderProps) => {
  const { setcustomer, showMessage, setShowMessage, companyName, setPickupDate,fetchData } = props
...
export default InvlicePaidHeader
