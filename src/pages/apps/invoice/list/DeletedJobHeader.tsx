...
const DeletedJobHeader = ({ bulkDelete, selectedRows, handleRestore }: any) => {
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: "space-between", width: "100%", }}>
          <Grid sx={{ display: 'flex', gap: "15px" }}>
            ...
            <CustomModal
              ...
              buttonText=''
            >
              <Typography sx={{ color: getColor() }}>Are you sure you want to Restore?</Typography>
              <div
...
export default DeletedJobHeader
