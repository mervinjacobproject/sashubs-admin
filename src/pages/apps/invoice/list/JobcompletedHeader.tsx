...
import { Box, Grid, IconButton, Tooltip, Autocomplete, Button } from '@mui/material'
...
const JobCompletedHeader = (props: TableHeaderProps) => {
  const {
    setcustomer,
    showMessage,
    setShowMessage,
          ...
          <Grid sx={{ display: 'flex', alignItems: 'center' }}>
            <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
              <DrawerComponent anchor='right' onOpen={handleOpenDrawer} buttonLabel='Add New'>
                <JobsteperformJob fetchData={fetchData}/>
              </DrawerComponent>
            </Box>
          </Grid>
        </Box>
...
export default JobCompletedHeader
