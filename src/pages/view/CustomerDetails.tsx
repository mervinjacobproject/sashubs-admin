...
import CustomerAddress from '../customer/customer/CustomerAddress'

import CustomerNew from '../customer/customer/CustomerNew'

const CustomerReference = dynamic(() => import('../customer/customer/CustomerReference'), {
  ssr: false,
});
...
function CustomerDetails() {
    ...
    const [customerData, setCusomerData] = useState<any | null>(null)
      ...
      const getStepContent = (step: number) => {
        switch (step) {
          case 0:
            return (
              <CustomerNew
                editid={currentEditId ? currentEditId : customerData?.Id}
      ...
      const backColor = () => {
       ...
       const fetchCustomerData = async () => {
        ...
        try {
          ...
          const filteredData = response.filter((row: any) => row.Id == customerID);
                ...
                <StepperWrapper sx={{ height: '100%' }}>
                  ...
                  >
                    {steps.map((step, index) => {
                      ...
                      const isStepDisabled = (index >= 1 && index <= 2) && (!customerData || !customerData.Id);
