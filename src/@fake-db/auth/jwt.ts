...
mock.onPost('/jwt/login').reply(request => {
  ...
  if (user) {
    ...
    const accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNzAwNzI0OTk1LCJleHAiOjE3MDA3MjUyOTV9.aX5wD7x89EpLkyo7agNgJURylgPJLnNNnXKJ75WSVco"
